...
`);
// 올바른 주민등록번호 생성 함수
function generateValidRRN(birthDate, gender) {
...
for (const data of sampleData) {
    insertStmt.run(data.txid, data.cxid, data.name, data.ihidnum, data.address, data.birth, data.title, data.issude, data.issuernm, data.foreignflag, data.provider, data.resultCode, data.clientMessage, data.signType, data.sex);
