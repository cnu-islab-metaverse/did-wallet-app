...
export const ISSUERS = {
  mois: { name: '행정안전부', id: 'did:web:www.mois.go.kr', prv: '0001020304050607080900010203040506070809000102030405060708090001' },
  police: { name: '경찰청', id: 'did:web:www.police.go.kr', prv: '0001020304050607080900010203040506070809000102030405060708090002' },
  cnu: { name: '충남대학교', id: 'did:web:cnu.ac.kr:registrar', prv: '0001020304050607080900010203040506070809000102030405060708090003' },
  hrdk: { name: '한국산업인력공단', id: 'did:web:www.hrdkorea.or.kr', prv: '0001020304050607080900010203040506070809000102030405060708090004' },
  nhis: { name: '국민건강보험공단', id: 'did:web:www.nhis.or.kr', prv: '0001020304050607080900010203040506070809000102030405060708090005' },
};
